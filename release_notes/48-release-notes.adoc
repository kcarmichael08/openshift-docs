...
* Uncontrolled recursion vulnerability in `node-forge` enables attackers to trigger unbounded recursive parsing with ASN.1 structures and cause denial of service (link:https://access.redhat.com/security/cve/cve-2025-66031[CVE-2025-66031])
