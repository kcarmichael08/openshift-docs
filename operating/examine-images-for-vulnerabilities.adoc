...
include::modules/deploy-roxagent-quadlet.adoc[leveloffset=+2]
include::modules/troubleshooting-vm-scanning.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* xref:../operating/manage-vulnerabilities/common-vuln-management-tasks.adoc#view-vms-cves_vms[Viewing vulnerabilities in virtual machines]
