...
= Understanding how {product-title-short} transforms the filtering criteria into policy criteria
...
* {product-title} ({product-title-short}) converts the *Cluster*, *Namespace*, and *Deployment* filters to equivalent policy scopes.
